 ...
 */
    ...
    auto BPLUSTREE_TYPE::GetValue(const KeyType &key, std::vector<ValueType> *result, Transaction *txn) -> bool {
        ...
        auto head_node = guard.As<BPlusTreeHeaderPage>();
 ...
 */
    ...
    auto BPLUSTREE_TYPE::Insert(const KeyType &key, const ValueType &value, Transaction *txn) -> bool {
        ...
        LOG_DEBUG("线程%d 操作-Find | key %s", getpid(), std::to_string(key.ToString()).c_str());
    ...
    INDEX_TEMPLATE_ARGUMENTS
    auto
    BPLUSTREE_TYPE::InsertParent(const KeyType &key, const page_id_t &value, Context &ctx, Transaction *txn) -> void {
 ...
 */
    INDEX_TEMPLATE_ARGUMENTS
    auto BPLUSTREE_TYPE::End() -> INDEXITERATOR_TYPE { return INDEXITERATOR_TYPE(bpm_, -1, 0); }
